...
export default function InvoicePdfView({ invoice, onBack }: InvoicePdfViewProps) {
  ...
  const handlePrintThermal = () => {
    ...
    printWindow.document.write(`
      ...
      <body>
        <div class="tip-bar">
          <strong>Tip:</strong> Select your <strong>thermal printer</strong> (not "Microsoft Print to PDF") in the Destination dropdown above. Paper size will be set to 80mm automatically. If printing to PDF, the receipt will appear on the left side of the page.
        </div>
